...
class EarningHistory extends Model {
  ...
  public static function get_earning_history_report($param){
      //  dd($param);
...
//                $flag=0;
        ...
        $tokenReport = self::where('user_id',$param['loggerId'])
                            ->skip($start)->take($len)
                            ->orderBy('id','desc');
     ...
     public static function filter_earning_report($param){
